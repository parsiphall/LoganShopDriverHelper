...
class DeliveryViewAdapterNew(
    private var items: List<Delivery>,
    private val context: Context
) : RecyclerView.Adapter<DeliveryViewHolderNew>() {

    private val ad = AlertDialog.Builder(context)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) = DeliveryViewHolderNew(
        LayoutInflater.from(context)
            .inflate(R.layout.delivery_item_new, parent, false)
    )
    ...
    override fun onBindViewHolder(holder: DeliveryViewHolderNew, position: Int) {
